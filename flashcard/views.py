...
def novo_flashcard(request):
    ...
    if request.method == "GET":
        ...
        #no caso da categoria eu passo a instancia da classe e o id para enviar pro banco (categoria_id)
        flashcard = Flashcard(
            user = request.user,
            pergunta = pergunta, 
            resposta = resposta, 
        ...
        flashcard.save()
        messages.add_message(request, constants.SUCCESS, 'Flashcard cadastrados com sucesso')
        return redirect('/flashcard/novo_flashcard/')
...
def deletar_flashcard(request, id):
    ...
    if flashcard.user == user:
        flashcard.delete()
        messages.add_message(request, constants.SUCCESS, 'Flashcard exclído com sucesso!')
    else:
        messages.add_message(request, constants.ERROR, 'Este Flashcard não pertence ao usuário!')
...
def listar_desafio(request):
    ...
    #return HttpResponse(desafios.flashcards.all)
